...
INSERT INTO `courses` VALUES (12,'WEBAPDE','S17',10811111,'MW','11:00','12:30'),(13,'OPERSYS','S16',10811111,'TH','12:30','2:15'),(14,'SPSWENG','S18',10811111,'MWTH','9:15','10:45'),(15,'KASPIL1','S15',10811111,'TH','9:15','10:45'),(16,'KASPIL2','S20',10711111,'MW','11:00','12:30'),(17,'TREDONE','S21',10711111,'MW','12:30','2:15'),(18,'TREDTWO','S22',10711111,'TH','2:30','4:00'),(19,'FROMDEV','S11',10711111,'TH','4:15','5:45'),(20,'WEBAPDE','S21',10811111,'Tuesday/Thursday','7:00','8:00');
...
CREATE TABLE `unavailablehours` (
  `unavailablehoursid` int(11) NOT NULL AUTO_INCREMENT,
  `idnum` int(11) NOT NULL,
  `course` varchar(45) NOT NULL,
  `section` varchar(45) NOT NULL,
  `date` date NOT NULL,
...
-- Dump completed on 2015-04-19 19:40:57
