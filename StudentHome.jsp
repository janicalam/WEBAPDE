...
<body>
	...
	<div class="container container-custom" id="containerID">
		...
		<div class="jumbotron jumbotron-custom">
			<div id="carousel_slider" class="carousel slide img-rounded"
				data-ride="carousel">
				<!-- Wrapper for slides -->
				<div class="carousel-inner" role="listbox">
					<div class="item img-rounded carousel-1">
						<div class="carousel-caption-custom ">
							...
							<a class="btn btn-info" href="ToStudentRequestConsultation">
								<strong>Request Consultation Now! <span
									class="glyphicon glyphicon-arrow-right"></span></strong>
							</a>
						</div>
					</div>
					<div class="item img-rounded carousel-2">
						<div class="carousel-caption-custom ">
							<h1>Consult Me</h1>
							<p>Requesting consultations has never been this easy!</p>
							<a class="btn btn-info" href="ToStudentViewRequest"> <strong>View
									Requests Now! <span class="glyphicon glyphicon-arrow-right"></span>
							</strong>
							</a>
						</div>
					</div>
					<div class="active item img-rounded carousel-3">
						<div class="carousel-caption-custom ">
							<h1>Consult Me</h1>
							<p>Requesting consultations has never been this easy!</p>
							<a class="btn btn-info" href="ToStudentEditCourseList"> <strong>Edit
									Course List Now! <span class="glyphicon glyphicon-arrow-right"></span>
							</strong>
							</a>
						</div>
					</div>
				...
				<div class="sliders">
					<a href="#carousel_slider" class="left carousel-control"
						data-slide="prev"> <span> < </span>
					</a> <a href="#carousel_slider" class="right carousel-control"
						data-slide="next"> <span> > </span>
					</a>
				</div>
			</div>
		</div>
			...
			<div class="col-md-12">
				<div class="col-md-12  trans img-rounded">
					<div class="col-md-4">
						<h3>About Us</h3>
						<hr class="break" />
						<p>CCS students have created this web application to help
							students and professors in De La Salle University in regards to
							booking a consultation.</p>
						<p>Created on S.Y. 2014-2015, 3rd Term for the course WEBAPDE
							which focuses on web application design.</p>
					</div>
					...
					<div class="col-md-4">
						<h3>Target Users</h3>
						<hr class="break" />
						<p>Consult Me is a web application that mainly targets
							students and professors of De La Salle University.</p>
						<p>As of the moment, the application is only limited to CCS
							students and its faculty.</p>
					</div>
