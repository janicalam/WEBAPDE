			...
			<div class="col-md-12 trans img-rounded">
				<div class="col-md-12">
					...
					<form class="form-horizontal" role="form" method="post"
						action="ProfessorChangePassword">

						<div class="form-group row">
							<label for="firstpass" class="control-label col-md-2">Old
								Password:</label>
							<div class="col-md-3">
								<input type="password" class="form-control" id="firstpass"
									name="pass" placeholder="Password">
							</div>
						</div>

						<div class="form-group row">
							<label for="newpass" class="control-label col-md-2">New
								Password:</label>
							<div class="col-md-3">
						...
						<div class="form-group row">
							<label for="confirmnewpass" class="control-label col-md-2">Confirm
								New Password:</label>
							<div class="col-md-3">
								<input type="password" class="form-control" id="confirmnewpass"
									name="confirmnewpass" placeholder="Enter New Password">
							</div>
						</div>
