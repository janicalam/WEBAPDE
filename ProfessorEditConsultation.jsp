          ...
          <div class = "row col-md-12">
            ...
            <div class = "col-md-6">
              ...
              <form class="form-horizontal" role="form">
                ...
                <div class="form-group row">
                  <label for="timestart" class = "control-label col-md-3">Time Start: </label>
                  <div class = "col-md-5">
                ...
                <div class="form-group row">
                  <label for="timeend" class = "control-label col-md-3">Time End: </label>
                  <div class = "col-md-5">
                  ...
                  <table class="table"  style="border-collapse:collapse;">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><button type = "submit" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-remove"></span> Remove </button></td>
                      </tr>
