    ...
    <nav class="navbar navbar-inverse navbar-custom navbar-fixed-top">
      ...
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <!-- software name start -->
          <a href="StudentHome.html" class="navbar-brand span-custom " style="padding-top: 13px">
        ...
        <ul class="collapse navbar-collapse nav navbar-nav nav-opt-custom" id = "links">
          ...
          <li><a href="StudentRequestConsultation.html">Request Consultation</a></li>
        ...
        <div class = "navbar-right collapse navbar-collapse" id = "user">
              <ul class="nav navbar-nav nav-user-custom">
                <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">
                  <span class="glyphicon glyphicon-user"></span><span class = "span-custom"> Miguel Sietereales</span> <span class="caret"></span></a>
                  <ul class="dropdown-menu">
                    <li><a href="StudentChangePassword.html"><span class="glyphicon glyphicon-cog"></span> Change Password</a></li>
          ...
          <div class = "col-md-6">
            ...
            <form class="form-horizontal" role="form">
              <div class="form-group row">
                <label for="coursecode" class = "control-label col-md-3">Course Code: </label>
                <div class = "col-md-5">
              ...
              <div class="form-group row">
                <label for="profname" class = "control-label col-md-3">Professor: </label>
                <div class = "col-md-5">
                ...
                <table class="table"  style="border-collapse:collapse;">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>8:30 - 13:30</td>
                      <td>Approved</td>
                      <td><button type = "submit" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-remove"></span> Cancel </button></td>
                    </tr>
