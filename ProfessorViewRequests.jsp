        ...
        <div class = "col-md-12 trans img-rounded">
          <div class = "col-md-6">
            ...
            <form class="form-horizontal" role="form">
              ...
              <div class="form-group row">
                <label for="profname" class = "control-label col-md-3">Student Name: </label>
                <div class = "col-md-5">
              ...
              <div class ="course-wrapper">
                <table class="table"  style="border-collapse:collapse;">
                  ...
                  <tbody>
                    <tr>
                      <td>WEBAPDE</td>
                      <td>Miguel Sietereales</td>
                      <td>8:30 - 13:30</td>
                      <td>Approved</td>
                      <td><button type = "submit" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-ok"></span> Approve </button></td>
                      <td><button type = "submit" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-remove"></span> Reject </button></td>
                    </tr>
