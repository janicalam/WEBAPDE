...
<html lang="en">
  ...
  <!-- header end -->
    ...
    <div class="container container-custom" id = "containerID">
                ...
                <table class="table"  style="border-collapse:collapse;">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><button type="button" class="btn btn-default btn-xs" data-toggle="modal" data-target="#sched1">
                          <span class="glyphicon glyphicon-calendar"></span> View Schedule</button>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td><button type="button" class="btn btn-default btn-xs" data-toggle="modal" data-target="#sched2">
                          <span class="glyphicon glyphicon-calendar"></span> View Schedule</button>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>S20</td>
                      <td>Ms. Ethel Ong</td>
                      <td><button type="button" class="btn btn-default btn-xs" data-toggle="modal" data-target="#sched3">
                          <span class="glyphicon glyphicon-calendar"></span> View Schedule</button>
                      </td>
                    </tr>
      ...
      <!-- modals -->
      <div class="modal modal-login fade" id="sched1" tabindex="-1" role="dialog" aria-labelledby="schedLabel1" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header" style = "background-color: #222; color: white; border-color: #FF3030;">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"></span></button>
              <h4 class="modal-title" id="schedLabel1"><span class="glyphicon glyphicon-calendar"></span> WEBAPDE - Ms. Courtney Ngo</h4>
            </div>
            <form class="form-horizontal" role="form">
              ...
              <div class="modal-footer">
                <center>
                  ...
                  <input type="submit" class="btn btn-info btn-custom" value="Submit"/>
                </center>
              </div>
            </form>
          </div>
      ...
      <!-- modals -->
      <div class="modal modal-login fade" id="sched2" tabindex="-1" role="dialog" aria-labelledby="schedLabel2" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header" style = "background-color: #222; color: white; border-color: #FF3030;">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"></span></button>
              <h4 class="modal-title" id="schedLabel2"><span class="glyphicon glyphicon-calendar"></span> OPERSYS - Mr. Solomon See</h4>
            </div>
            <form class="form-horizontal" role="form">
              <div class="modal-body modal-wrapper">
                <table class="table">
      ...
      <div class="modal modal-login fade" id="sched1" tabindex="-1" role="dialog" aria-labelledby="schedLabel1" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header" style = "background-color: #222; color: white; border-color: #FF3030;">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"></span></button>
              <h4 class="modal-title" id="schedLabel1"><span class="glyphicon glyphicon-calendar"></span> SPSWENG - Ms. Ethel Ong</h4>
            </div>
            <form class="form-horizontal" role="form">
              <div class="modal-body modal-wrapper">
                <table class="table">
